    ...
    <header className="site-header">
      <div className="container-page header-inner">
        ...
        <button
          ...
          className="md:hidden mobile-menu-btn p-3 text-white hover:text-yellow-300 transition-colors bg-gray-800 hover:bg-gray-700 rounded-md border border-gray-600"
